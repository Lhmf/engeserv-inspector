              ...
              <tbody className="divide-y divide-slate-100">
                {filtered.map((laudo) => (
                  <tr key={laudo.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-4 py-3 text-slate-600">{laudo.clientName}</td>
                    <td className="px-4 py-3 text-slate-500">{formatDate(laudo.inspectionDate)}</td>
                    <td className="px-4 py-3">
                    ...
                    <td className="px-4 py-3 text-right">
                      <Link
                        ...
                        className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-navy text-white text-sm font-medium hover:bg-navy/90 transition-colors"
                      >
