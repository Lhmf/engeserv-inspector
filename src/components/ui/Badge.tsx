...
export function Badge({ className, variant = "default", size = "md", dot = false, children, ...props }: BadgeProps) {
  ...
  const variants = {
    ...
    neutral: "bg-slate-50 text-slate-600 dark:bg-slate-800/60 dark:text-slate-300",
    outline: "border border-slate-300 bg-transparent text-slate-600 dark:border-slate-600 dark:text-slate-300",
  };
